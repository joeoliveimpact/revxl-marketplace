...
## Use
Say **"my plugin won't update"** or run `/plugin-doctor`. It diagnoses which of the two stall types you have, then walks the fix — CLI commands on Claude Code, click-by-click steps on Claude Desktop.
