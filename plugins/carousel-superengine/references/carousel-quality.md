...
- [ ] Coach's voice at configured `{{VOICE_EDGE}}`... reads like them, not like a framework
...
- [ ] Every number, result, client story is REAL — from `{{PROOF_ASSETS}}` / story elicitation;
      nothing invented, nothing rounded up
- [ ] No false scarcity or fake deadlines
- [ ] Health claims within what the coach can substantiate; disclaimer where warranted
- [ ] Teardown rebuilds: STRUCTURE borrowed, zero wording/examples/images from the source post
...
- [ ] Platform variant deltas listed when `both`
- [ ] Matches the density of @exemplar-carousel.md... a thin package doesn't ship
