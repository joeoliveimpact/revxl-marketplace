...
- New humor candidates → score + file silently as candidates (${CLAUDE_PLUGIN_ROOT}/skills/brand-brain/references/signature-bits.md — ceremony parked; deployability gates + evidence strength apply).
