...
## Voice (brand-owner turns + tier-B written)
...
## Humor
Route candidates to ${CLAUDE_PLUGIN_ROOT}/skills/brand-brain/references/signature-bits.md scoring. Evergreen bits → signature-bits.md (pending canonization). Topical jokes → weekly-content-bank.md.
