...
- **Nothing through C** → route to ${CLAUDE_PLUGIN_ROOT}/references/brand-brain/interview.md.
...
Per ${CLAUDE_PLUGIN_ROOT}/references/brand-brain/speaker-separation.md then ${CLAUDE_PLUGIN_ROOT}/references/brand-brain/extraction.md:
...
- Score humor candidates per ${CLAUDE_PLUGIN_ROOT}/references/brand-brain/signature-bits.md.
