...
**B3 — the confirming probe — belongs to this skill too, and it fires at Step 7**, not here:
that's where the unattended-execution promise gets made, and B3 is the rule that says you try
the thing for real once, for the chosen tool only, before promising it runs.
