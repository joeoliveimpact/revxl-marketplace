...
16 plugins. Versions are current as of catalog `0.1.45`.
...
| Plugin | Version | What it does |
|---|---|---|
| [promptception](plugins/promptception/) | 0.3.2 | Prompts that write prompts: brain-dump in, expert prompt out. Orchestrator Mode (tiered subagent crew + premortem), builders for `/goal`, `/loop`, `/schedule`, plus `/plan-builder` for jobs too big for one prompt. 7 skills + 5 agents. |
